...
// This function retrieves a list of users for the sidebar, excluding the logged-in user.
// It uses the User model to find all users except the one currently logged in.
...
export const getMessages = async (req, res) => {
  try {
    ...
    // and the other user is the opposite party.
